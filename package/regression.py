        ...
        pail_vitamin_d_one = (
            drive_linear_regressions_cohorts_dependences_models(
                ...
                independences_summary=[
                    ...
                    "assessment_site_indicator_leeds",
                    "assessment_site_indicator_bristol",
                    "assessment_site_indicator_newcastle",
                    "assessment_site_indicator_nottingham",
                    "assessment_site_indicator_liverpool",
                    "assessment_site_indicator_sheffield",
                    "assessment_site_indicator_reading",
                    "assessment_site_indicator_hounslow",
                    "assessment_site_indicator_bury",
                    "assessment_site_indicator_croydon",
                    "assessment_site_indicator_birmingham",
                    "assessment_site_indicator_middlesborough",
                    "assessment_site_indicator_stoke",
                    "assessment_site_indicator_glasgow",
                    "assessment_site_indicator_cardiff",
                    "assessment_site_indicator_edinburgh",
